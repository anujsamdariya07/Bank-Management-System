...
public class Deposit extends JFrame implements ActionListener
{
    ...
    Deposit(String stringPin)
    {
        ...
        // Introduction
        introduction = new JLabel("Enter the amount you want to deposit");
        ...
        deposit.setBounds(360, 428, 150, 25);
